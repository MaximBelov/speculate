...
module.exports = {
  sysConfigFile: function (root, pkg) {
    return path.resolve(root + '/sysconfig', pkg.name + '.service');
  },
  sysConfigDirectory: function (root, pkg) {
    return path.resolve(root, 'sysconfig');
  },
